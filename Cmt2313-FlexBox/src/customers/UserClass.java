...
public class UserClass extends UserScreen{
	...
	public String USER_PATH = "FlexBox/Users/userInfo.csv";
	public String DIRECTORY_PATH = "FlexBox/Users";
	...
	/**
	 * This method holds the default users
	 * @return
	 */
	public static ArrayList<UserClass> defaultUsers(){
		...
		defaultUsers.add(new UserClass("First", "User", "FlexBox Ltd","+4412345678", "admin1", "admin123", true, true));
		defaultUsers.add(new UserClass("Second", "User", "FlexBox Ltd","+4412345678", "admin2", "admin321", true, true));
